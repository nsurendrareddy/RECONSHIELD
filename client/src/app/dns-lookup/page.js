            ...
            "@graph": [
              {
                ...
                "@id": "https://reconshield.in/dns-lookup#software",
              ...
              {
                "@type": "BreadcrumbList",
                "@id": "https://reconshield.in/dns-lookup#breadcrumb",
                "itemListElement": [
                  { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://reconshield.in" },
                  { "@type": "ListItem", "position": 2, "name": "Tools", "item": "https://reconshield.in/tools" },
                  { "@type": "ListItem", "position": 3, "name": "DNS Lookup", "item": "https://reconshield.in/dns-lookup" }
                ]
              },
              {
                "@type": "FAQPage",
                "@id": "https://reconshield.in/dns-lookup#faq",
      ...
      <section className="relative pt-24 pb-20 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center animate-fade-in-up">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Instantly enumerate domain records with our <strong>domain intelligence tool</strong>. Verify A, AAAA, MX, and TXT records, perform an <strong>SPF checker</strong> audit, and monitor global DNS propagation.
          </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">DMARC ties SPF and DKIM together. We check if your DMARC policy is set to `reject` or `quarantine`, preventing attackers from spoofing your domain in phishing campaigns.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-[#0a0d14]">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/ip-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-cyan-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/whois" className="p-6 bg-surface-900 border border-white/5 hover:border-cyan-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/vulnerability-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-cyan-500/30 rounded-2xl group transition-all">
