...
export const metadata = {
  title: "Security Headers Analyzer & Website Hardening Tool | ReconShield",
            ...
            "@graph": [
              {
                ...
                "@id": "https://reconshield.in/security-headers#software",
              ...
              {
                "@type": "BreadcrumbList",
                "@id": "https://reconshield.in/security-headers#breadcrumb",
                "itemListElement": [
                  { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://reconshield.in" },
                  { "@type": "ListItem", "position": 2, "name": "Tools", "item": "https://reconshield.in/tools" },
                  { "@type": "ListItem", "position": 3, "name": "Security Headers", "item": "https://reconshield.in/security-headers" }
                ]
              },
              {
                "@type": "FAQPage",
                "@id": "https://reconshield.in/security-headers#faq",
      ...
      <div className="bg-[#05080f]">
        ...
        <section className="py-20 border-b border-white/5">
          <div className="max-w-[900px] mx-auto px-6 prose prose-invert max-w-none prose-p:leading-relaxed prose-p:text-gray-400 prose-headings:text-white prose-a:text-amber-500 hover:prose-a:text-amber-400">
            ...
            <p>
              Traditional server-side security (like firewalls and WAFs) protects the backend infrastructure. However, the majority of modern cyber attacks—such as Cross-Site Scripting (XSS), credential harvesting, and session hijacking—occur in the victim's browser. <strong>HTTP security headers</strong> act as a client-side firewall, restricting the browser's capabilities and mitigating the impact of application vulnerabilities.
            </p>
        ...
        <section className="py-20 border-b border-white/5">
          <div className="max-w-[900px] mx-auto px-6 prose prose-invert max-w-none prose-p:text-gray-400">
            ...
            <ul>
              ...
              <li><strong>Bug Bounty Research:</strong> Pentesters scan targets for missing headers. The absence of `X-Frame-Options` is frequently submitted as a low-hanging clickjacking vulnerability.</li>
            </ul>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 p-8 bg-gradient-to-r from-[#0d1117] to-surface-900 border border-white/10 rounded-3xl shadow-xl">
              ...
              <div>
                ...
                <div className="flex gap-6 text-sm font-mono">
                  <a href="#" className="text-amber-500 hover:text-amber-400 flex items-center gap-1">LinkedIn <ChevronRight className="w-3 h-3"/></a>
        ...
        <section className="py-20 bg-[#0a0d14]">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/vulnerability-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-amber-500/30 rounded-2xl group transition-all">
                <Shield className="w-6 h-6 text-amber-500 mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-bold mb-2 group-hover:text-amber-500 transition-colors">Website Vulnerability Scanner</h3>
              ...
              <Link href="/ssl-checker" className="p-6 bg-surface-900 border border-white/5 hover:border-amber-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/port-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-amber-500/30 rounded-2xl group transition-all">
