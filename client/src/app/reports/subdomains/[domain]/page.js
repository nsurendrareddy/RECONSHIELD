          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="p-6 rounded-2xl bg-gradient-to-b from-[#0d1117] to-transparent border border-white/5 sticky top-24">
                ...
                <div className="space-y-3">
                  <Link href={`/tools/ssl-checker?target=${domain}`} className="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
                  ...
                  <Link href={`/tools/dns-lookup?target=${domain}`} className="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Query target nameservers</div>
                    </div>
                  </Link>

                  <Link href={`/tools/port-scanner?target=${domain}`} className="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
