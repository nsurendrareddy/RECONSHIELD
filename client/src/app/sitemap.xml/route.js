...
const SITEMAP_TYPES = ['core', 'tools', 'blog', 'ip', 'malicious-ips', 'asn', 'ports', 'ssl', 'dns', 'whois', 'subdomains', 'headers', 'dns-types', 'ssl-errors', 'email-auths', 'technology', 'vulnerability'];
