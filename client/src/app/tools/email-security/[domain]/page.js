    ...
    '@graph': [
      {
        ...
        headline: `${domain} Email Authentication and Brand Protection Audit`,
        description: `Detailed analysis documenting SPF records, DKIM configurations, and DMARC alignments for ${domain}.`,
        publisher: {
          '@type': 'Organization',
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="p-6 rounded-2xl bg-[#0d1117] border border-white/5 relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  Active Email Authentication Check
                </h2>
                ...
                <h3 className="text-sm font-bold font-mono text-cyan-400 uppercase tracking-wider mb-3">// Parsed DNS Authentication Records</h3>
