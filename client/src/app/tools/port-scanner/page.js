            ...
            "@graph": [
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Port Scanner", "item": "https://reconshield.in/tools/port-scanner" }
                ]
              },
              {
                "@type": "FAQPage",
        ...
        <section className="py-20 bg-[#0a0d14]">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/tools/ip-lookup" className="p-6 bg-surface-900 border border-white/5 hover:border-red-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/tools/ssl-checker" className="p-6 bg-surface-900 border border-white/5 hover:border-red-500/30 rounded-2xl group transition-all">
