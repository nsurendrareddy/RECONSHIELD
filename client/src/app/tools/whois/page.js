            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-2xl bg-surface-900 border border-white/5 hover:border-purple-500/20 transition-all flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-2 font-mono text-xs text-purple-400">
                  <a href="https://www.effectivecpmnetwork.com/fe65rdif?key=82071772b3cc6d1de386046b7a927b03" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-1">▸ Domain Ownership Verification <ChevronRight className="w-3.5 h-3.5" /></a>
                  <a href="https://www.effectivecpmnetwork.com/fe65rdif?key=82071772b3cc6d1de386046b7a927b03" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-1">▸ Domain Expiration Monitoring <ChevronRight className="w-3.5 h-3.5" /></a>
                </div>
              </div>
