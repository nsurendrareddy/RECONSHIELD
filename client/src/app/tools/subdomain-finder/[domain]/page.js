    ...
    '@graph': [
      {
        ...
        headline: `${domain} Subdomain Mapping and Asset Discovery Report`,
        description: `Technical audit documenting known subdomain namespaces, DNS zone delegations, and hosting platforms connected to ${domain}.`,
        publisher: {
          '@type': 'Organization',
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="p-6 rounded-2xl bg-[#0d1117] border border-white/5 relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  Active Subdomain Discovery Resolver
                </h2>
