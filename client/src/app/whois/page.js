...
export const metadata = {
  title: "WHOIS Lookup & Domain Intelligence Tool | ReconShield",
  ...
  alternates: {
    canonical: 'https://reconshield.in/whois',
  },
  openGraph: {
    title: "WHOIS Lookup & Domain Intelligence Tool",
    description: "Free WHOIS checker and RDAP lookup tool. Perform domain ownership lookup, analyze registration data, and uncover domain intelligence instantly.",
    url: 'https://reconshield.in/whois',
    type: 'article',
  }
};
            ...
            "@graph": [
              {
                ...
                "@id": "https://reconshield.in/whois#software",
              ...
              {
                "@type": "BreadcrumbList",
                "@id": "https://reconshield.in/whois#breadcrumb",
                "itemListElement": [
                  { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://reconshield.in" },
                  { "@type": "ListItem", "position": 2, "name": "Tools", "item": "https://reconshield.in/tools" },
                  { "@type": "ListItem", "position": 3, "name": "WHOIS Lookup", "item": "https://reconshield.in/whois" }
                ]
              },
              {
                "@type": "FAQPage",
                "@id": "https://reconshield.in/whois#faq",
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 p-8 bg-gradient-to-r from-[#0d1117] to-surface-900 border border-white/10 rounded-3xl shadow-xl">
              ...
              <div>
                ...
                <div className="flex gap-6 text-sm font-mono">
                  <a href="#" className="text-teal-400 hover:text-teal-300 flex items-center gap-1">LinkedIn <ChevronRight className="w-3 h-3"/></a>
        ...
        <section className="py-20 bg-[#0a0d14]">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/dns-lookup" className="p-6 bg-surface-900 border border-white/5 hover:border-teal-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/ip-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-teal-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/port-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-teal-500/30 rounded-2xl group transition-all">
