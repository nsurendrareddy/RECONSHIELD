    ...
    '@graph': [
      {
        ...
        headline: `Sample Website Security Assessment (Illustrative) for ${domain}`,
        description: `Demonstration report documenting active security configurations, SSL parameters, DNS setups, and vulnerability risk scoring for ${domain} using simulated data.`,
        publisher: {
          '@type': 'Organization',
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="p-6 rounded-2xl bg-[#0d1117] border border-white/5 relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  Sample Security Intelligence (Illustrative)
                </h2>
                ...
                <h3 className="text-sm font-bold font-mono text-cyan-400 uppercase tracking-wider mb-3">// Example Telemetry Highlights (Demo Data)</h3>
