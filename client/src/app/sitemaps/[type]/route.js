  ...
  try {
    ...
    if (entityType === 'core' && page === 1) {
      const staticUrls = [
        ...
        { url: `${BASE_URL}/cookie-policy`, priority: 0.3, freq: 'yearly' },
        { url: `${BASE_URL}/disclaimer`, priority: 0.3, freq: 'yearly' },
        { url: `${BASE_URL}/editorial-policy`, priority: 0.3, freq: 'yearly' },
        ...
        { url: `${BASE_URL}/vulnerability`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/email-auth`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/dns-analysis`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/ip-intelligence`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/ports`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/ssl`, priority: 0.8, freq: 'weekly' },
        { url: `${BASE_URL}/subdomains`, priority: 0.8, freq: 'weekly' },
