            ...
            "@graph": [
              {
                ...
                "@id": "https://reconshield.in/ssl-checker#software",
              ...
              {
                "@type": "BreadcrumbList",
                "@id": "https://reconshield.in/ssl-checker#breadcrumb",
                "itemListElement": [
                  { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://reconshield.in" },
                  { "@type": "ListItem", "position": 2, "name": "Tools", "item": "https://reconshield.in/tools" },
                  { "@type": "ListItem", "position": 3, "name": "SSL Checker", "item": "https://reconshield.in/ssl-checker" }
                ]
              },
              {
                "@type": "FAQPage",
                "@id": "https://reconshield.in/ssl-checker#faq",
        ...
        <section className="py-20 bg-[#0a0d14]">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/security-headers" className="p-6 bg-surface-900 border border-white/5 hover:border-purple-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/vulnerability-scanner" className="p-6 bg-surface-900 border border-white/5 hover:border-purple-500/30 rounded-2xl group transition-all">
              ...
              <Link href="/dns-lookup" className="p-6 bg-surface-900 border border-white/5 hover:border-purple-500/30 rounded-2xl group transition-all">
