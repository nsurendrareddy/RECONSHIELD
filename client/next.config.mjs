...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/tools/whois-checker', destination: '/tools/whois', permanent: true },
      { source: '/tools/whois-checker/:domain', destination: '/domain/:domain', permanent: true },
      { source: '/tools/whois-checker/:path*', destination: '/tools/whois/:path*', permanent: true },
      { source: '/tools/security-headers', destination: '/tools/http-headers', permanent: true },
      { source: '/tools/security-headers/:path*', destination: '/tools/http-headers/:path*', permanent: true },
      { source: '/tools/email-security-checker', destination: '/tools/email-security', permanent: true },
      { source: '/tools/email-security-checker/:path*', destination: '/tools/email-security/:path*', permanent: true },
      ...
      { source: '/dns', destination: '/tools/dns-lookup', permanent: true },
      { source: '/dns/:path+', destination: '/dns-records/:path+', permanent: true },
